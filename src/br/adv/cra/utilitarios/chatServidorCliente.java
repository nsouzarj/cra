...
public class chatServidorCliente extends Thread {
	...
	public static void main(String args[]) {
		try {
			...
			Socket socket = new Socket("192.168.0.133", 85);
			...
			Thread thread = new chatServidorCliente(socket);
			thread.start();
