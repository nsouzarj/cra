...
public class chatServidor extends Thread {
	...
	public chatServidor(Socket socket) {
		this.conexao = socket;
	}
	...
	public static void main(String args[]) {
		...
		try {
			...
			ServerSocket server = new ServerSocket(85);
			System.out.println("ServidorSocket rodando na porta 85");
			// Loop principal.
			while (true) {
				...
				Thread t = new chatServidor(conexao);
				t.start();
